...
import com.curtisnewbie.model.UserRepositoryUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/design", "/orders").hasRole("USER")
                ...
                .antMatchers("/", "/**").permitAll().and().formLogin().loginPage("/login").defaultSuccessUrl("/design")
                // custom logout page and where should user redirect to when logged out. The
                // default
